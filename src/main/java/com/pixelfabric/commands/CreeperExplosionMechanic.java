...
public class CreeperExplosionMechanic {
    private static final String COMMAND_NAME = "togglecreeperexplosionrange";
            ...
            dispatcher.register(CommandManager.literal(COMMAND_NAME)
                    ...
                    .executes(context -> {
                        ...
                        context.getSource().sendFeedback(
                                () -> Text.literal("Rango de explosión de Creepers aumentado en 70% " + status),
                                true
                        );
                        return 1;
                    })
    ...
    public static boolean isCreeperExplosionRangeActive() {
