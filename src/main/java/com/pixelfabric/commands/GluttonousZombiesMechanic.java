...
public class GluttonousZombiesMechanic {
    private static final String COMMAND_NAME = "togglegluttonouszombies";
            ...
            dispatcher.register(CommandManager.literal(COMMAND_NAME)
                    ...
                    .executes(context -> {
                        ...
                        context.getSource().sendFeedback(
                                () -> Text.literal("§2Zombies glotones " + status),
                                true
                        );
                        return 1;
                    })
    ...
    public static boolean isGluttonousZombiesActive() {
