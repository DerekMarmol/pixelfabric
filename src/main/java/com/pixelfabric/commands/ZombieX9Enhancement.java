...
public class ZombieX9Enhancement {
    private static final String COMMAND_NAME = "togglezombiex9";
            ...
            dispatcher.register(CommandManager.literal(COMMAND_NAME)
                    ...
                    .executes(context -> {
                        ...
                        context.getSource().sendFeedback(
                                () -> Text.literal("Mejora de zombies #5: daño x9 " + status),
                                true
                        );
                        return 1;
                    })
    ...
    public static boolean isZombieX9Active() {
