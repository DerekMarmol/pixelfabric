...
public class CorruptWitchMechanic {
    private static final String COMMAND_NAME = "togglecorruptwitch";
            ...
            dispatcher.register(CommandManager.literal(COMMAND_NAME)
                    ...
                    .executes(context -> {
                        ...
                        context.getSource().sendFeedback(
                                () -> Text.literal("§dBrujas corruptas (controles invertidos) " + status),
                                true
                        );
                        return 1;
                    })
    ...
    public static boolean isCorruptWitchActive() {
