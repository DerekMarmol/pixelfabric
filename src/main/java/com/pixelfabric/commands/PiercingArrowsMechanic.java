...
public class PiercingArrowsMechanic {
    private static final String COMMAND_NAME = "togglepiercingarrows";
            ...
            dispatcher.register(CommandManager.literal(COMMAND_NAME)
                    ...
                    .executes(context -> {
                        ...
                        context.getSource().sendFeedback(
                                () -> Text.literal("§bFlechas perforantes de esqueletos " + status),
                                true
                        );
                        return 1;
                    })
    ...
    public static boolean isPiercingArrowsActive() {
